        ...
        <div class="container">
            <div class="banner_content text-center">
                ...
                <div class="page_link">
                    ...
                    <a href="?scope=page&action=showProductDetail?id=">Abc</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row s_product_inner">
                ...
                <div class="s_product_img">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        <ol class="carousel-indicators">
                            ...
                            <li data-target="#carouselExampleIndicators" data-slide-to="<?=$active?>" class="<?php if(!$active) {echo "active";}?>">
                                <img src="<?=$this->asset($item)?>" alt="" width="60" height="60" style="object-fit: cover">
                            </li>
                            <?php ++$active ?>
                            <?php endforeach; ?>
                        </ol>
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item <?php if(!$active) {echo "active";}?>">
                                <img class="d-block w-100" src="<?=$this->asset($item)?>" alt="First slide">
                            </div>
                            <?php ++$active ?>
                            <?php endforeach; ?>
                        </div>
            ...
            <div class="col-lg-5 offset-lg-1">
                <div class="s_product_text">
                    ...
                    <p><?=@$product['sort_description'][0]?></p>
